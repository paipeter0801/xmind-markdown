...
<header class={cn('w-full py-4 px-6 bg-white dark:bg-slate-800 border-b border-slate-200 dark:border-slate-700', className)}>
		...
		<div class="flex items-center justify-between">
			...
			<div class="flex items-center gap-4">
				...
				<a
					...
					class="hidden sm:flex items-center gap-2 px-3 py-1.5 rounded-lg text-sm font-medium text-slate-700 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-700 transition-colors"
